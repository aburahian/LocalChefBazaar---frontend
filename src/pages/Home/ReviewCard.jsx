...
const ReviewCard = ({ review }) => {
  ...
  return (
    <div className="relative bg-white shadow-lg rounded-xl p-6 border-l-4 border-orange-400 flex flex-col sm:flex-row gap-6 max-w-xl mx-auto">
      ...
      <div className="absolute top-4 right-4 text-orange-400 text-3xl font-bold opacity-20">“</div>
    </div>
  );
};
