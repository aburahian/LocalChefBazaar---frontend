            ...
            <Container>
                <div className="text-center mb-16 contact-item">
                    ...
                    <p className="text-gray-500 text-lg max-w-2xl mx-auto">
                        Have a question about our meals or want to become a chef? Reach out to us, and we'll be happy to help.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold text-gray-800">+880 1234 567 890</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="p-4 bg-primary/10 rounded-2xl text-primary">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold text-gray-800">support@localchefbazaar.com</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="p-4 bg-primary/10 rounded-2xl text-primary">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-lg font-semibold text-gray-800">123 Chef Street, Satkhira, Bangladesh</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-gray-50 contact-item">
                        <h2 className="text-2xl font-bold text-gray-800 mb-8 flex items-center gap-2">
                            Send us a Message <FaPaperPlane className="text-primary text-xl" />
                        </h2>
