      ...
      <Container>
        ...
        <div className="text-center mb-20 about-section">
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 dark:text-white mb-6">
            Bringing the <span className="text-primary">Community</span>{" "}
            Together Through Food
          </h1>
          <p className="text-gray-500 dark:text-gray-400 text-xl max-w-3xl mx-auto leading-relaxed">
            LocalChefBazaar is more than just a meal-sharing platform. It's a
            place where neighbors share their passion for cooking, and everyone
            can enjoy healthy, homemade food.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24 about-section">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed">
              Founded in Satkhira, LocalChefBazaar started with a simple idea:
              why should great homemade food be limited to one family? We
              noticed that many talented home cooks wanted to share their
              creations, and many busy professionals were tired of processed
              restaurant food.
            </p>
            <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed">
              We built this platform to bridge that gap, creating a marketplace
              where quality, safety, and community come first.
            </p>
        ...
        <div className="text-center mb-16 about-section">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-lg max-w-2xl mx-auto">
            These principles guide every decision we make and every meal we
            serve.
          </p>
        </div>
          ...
          {[
            {
              icon: <FaHeart />,
              title: "Passion",
              desc: "Every meal is prepared with love and care by our dedicated home chefs.",
            },
            {
              icon: <FaShieldAlt />,
              title: "Quality",
              desc: "We maintain strict standards for hygiene and ingredient freshness.",
            },
            {
              icon: <FaUsers />,
              title: "Community",
              desc: "We believe in supporting local talent and building neighborhood bonds.",
            },
            {
              icon: <FaUtensils />,
              title: "Diversity",
              desc: "Our platform offers a wide range of authentic, traditional cuisines.",
            },
          ].map((item, index) => (
            <div
              key={index}
